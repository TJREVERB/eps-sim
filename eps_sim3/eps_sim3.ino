...
int digitalReadWrapper(int pin)
{
  return pin_statuses[pin];
}

int digitalWriteWrapper(int pin, int val)
{
  digitalWrite(pin, val);
  pin_statuses[pin] = val;
  return val;
}

void writeValue(int pin,int high_low) {
  if(high_low>0) digitalWriteWrapper(pin,LOW);
  else digitalWriteWrapper(pin,HIGH);
}
...
void set_pcm_reset(int data){
  if(data == 0x01){
    digitalWriteWrapper(BV, LOW);
  }
  else if(data == 0x02){
    digitalWriteWrapper(V5, LOW);
  }
  else if(data == 0x03){
    digitalWriteWrapper(V5, LOW);
    digitalWriteWrapper(BV, LOW);
  ...
  delay(500);
  digitalWriteWrapper(V12, HIGH);
  digitalWriteWrapper(BV, HIGH);
  digitalWriteWrapper(V3_3, HIGH);
  digitalWriteWrapper(V5, HIGH);
}
...
void get_PDM_status(int data){
  switch(data) {
    case 1:
      Wire.write(digitalReadWrapper(SW0));
      break;
    case 2:
      Wire.write(digitalReadWrapper(SW1));
      break;
    case 3:
      Wire.write(digitalReadWrapper(SW2));
      break;
    case 4:
      Wire.write(digitalReadWrapper(SW3));
      break;
    case 5:
      Wire.write(digitalReadWrapper(SW4));
      break;
    case 6:
      Wire.write(digitalReadWrapper(SW5));
      break;
    case 7:
      Wire.write(digitalReadWrapper(SW6));
      break;
    case 8:
      Wire.write(digitalReadWrapper(SW7));
      break;
    case 9:
      Wire.write(digitalReadWrapper(SW8));
      break;
    case 10:
      Wire.write(digitalReadWrapper(SW9));
      break;
  }
}
...
void set_all_PDM_on() {
  for (int x = 0; x<=9; x++){
    digitalWriteWrapper(x+2, LOW);
  }
}
void set_all_PDM_off() {
  for (int x = 0; x<=9; x++){
    digitalWriteWrapper(x+2, HIGH);
  }
}
void set_PDM_on(int data) {
  switch(data) {
    case 1:
      digitalWriteWrapper(SW0, LOW);
      break;
    case 2:
      digitalWriteWrapper(SW1, LOW);
      break;
    case 3:
      digitalWriteWrapper(SW2, LOW);
      break;
    case 4:
      digitalWriteWrapper(SW3, LOW);
      break;
    case 5:
      digitalWriteWrapper(SW4, LOW);
      break;
    case 6:
      digitalWriteWrapper(SW5, LOW);
      break;
    case 7:
      digitalWriteWrapper(SW6, LOW);
      break;
    case 8:
      digitalWriteWrapper(SW7, LOW);
      break;
    case 9:
      digitalWriteWrapper(SW8, LOW);
      break;
    case 10:
      digitalWriteWrapper(SW9, LOW);
      break;
    case 11:
    case 12:
    case 13:
...
void set_PDM_off(int data){
  switch(data) {
    case 1:
      digitalWriteWrapper(SW0, HIGH);
      break;
    case 2:
      digitalWriteWrapper(SW1, HIGH);
      break;
    case 3:
      digitalWriteWrapper(SW2, HIGH);
      break;
    case 4:
      digitalWriteWrapper(SW3, HIGH);
      break;
    case 5:
      digitalWriteWrapper(SW4, HIGH);
      break;
    case 6:
      digitalWriteWrapper(SW5, HIGH);
      break;
    case 7:
      digitalWriteWrapper(SW6, HIGH);
      break;
    case 8:
      digitalWriteWrapper(SW7, HIGH);
      break;
    case 9:
      digitalWriteWrapper(SW8, HIGH);
      break;
    case 10:
      digitalWriteWrapper(SW9, HIGH);
      break;
    case 11:
    case 12:
    case 13:
